"""
Django settings for image_text_adder project.
...
SECRET_KEY = 'django-insecure-x2=(yth6mc(_qa^g+ijetix9$r9gt!5_!a!hs)x*4__x3cl=js'
...
ROOT_URLCONF = 'image_text_adder.urls'
...
WSGI_APPLICATION = 'image_text_adder.wsgi.application'
